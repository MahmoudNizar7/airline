    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-0">
        <div class="container">
            <a class="navbar-brand mx-0" href="{{ route('home') }}">
                {{--<img src="{{ asset('assets/images/'. $app_data[8]->value) }}" alt=""></a>--}}
                <img src="front/img/logo/logo.png" alt=""></a>
                        ...
                        <li class="nav-item dropdown nav-register ">
                            <a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button"
                               ...
                               aria-haspopup="true" aria-expanded="false">
                                <i class="icon-man-user"></i>{{ ucfirst(auth('client')->user()->name) }}
                                | {{ isset(auth('client')->user()->balance->balance) ? auth('client')->user()->balance->balance : 0  }}
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item"
                                   href="{{ route('reservations.show', auth('client')->id()) }}"><i
                                        class="fas fa-plane-departure"></i>{{ __('site.my_trips') }}</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ route('profile.show') }}"><i
                                        class="icon-man-user"></i>{{ __('site.profile') }}</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ route('balances.show',auth('client')->id()) }}"><i
                                        class="fas fa-file-invoice-dollar"></i>{{ __('site.balance') }}</a>
                                <div class="dropdown-divider"></div>
