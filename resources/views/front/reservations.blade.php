                ...
                <div class="container">
                    <div class="content-warper wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                        ...
                        <form action="{{ route('client_trips.store') }}" method="post">
                            ...
                            @if($adults > 0)
                                <h3 class="two-line-heading text-center" style="margin-bottom:30px;">Adults</h3>
                                ...
                                @for($no = 0 ; $no < $adults; $no++ )
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-lg-2">
                                            <label for="bod">Nationality</label>
                                        ...
                                        <div class="col-lg-2">
                                            <label for="passport_ex_date" style="font-size:12px">Passport Expiration Date</label>
                            ...
                            @if($children > 0)
                                <hr>
                                <h3 class="two-line-heading text-center" style="margin-bottom:30px;">children</h3>
                                @for($no = 0 ; $no < $children; $no++ )
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-lg-2">
                                            <label for="passport_ex_date" style="font-size:12px">Passport Expiration
                                                Date</label>
                            ...
                            @if($baby > 0)
                                <hr>
                                <h3 class="two-line-heading text-center" style="margin-bottom:30px;">Baby</h3>
                                @for($no = 0 ; $no < $baby; $no++ )
                            ...
                            <hr>
                          <h6 class=" text-center" style="margin-bottom:30px;">Reservation Type</h6>
                            <div class="row align-items-center">
                                <div class="col-lg-4">
                                    <input class="@error('type') is-invalid @enderror" name="type" id="type" type="radio" value="1"  required>
                                    <label for="type">confirmed reservation</label>
                                </div>
                                <div class="col-lg-4">
                                    <input class="@error('type') is-invalid @enderror" name="type" id="type" type="radio" value="0"   required>
                                    <label for="type">Initial reservation</label>
                                </div>
                                @error('type') <span class="text-danger error">{{ $message }}</span> @enderror
                                <div class="col-lg-12">
                                    <button type="submit" class="btn btn-subscripe btn-hover" data-toggle="modal" data-target="#myModal" ><i class="icon-checked ml-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>Reserve Now</button>
                                </div>
                            </div>
                        </form>
