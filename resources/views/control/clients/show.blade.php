                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row mb-25">
                                ...
                                <div class="col-9">
                                    <input name="name" value="{{ $client->name }}" class="form-control" type="text" id="name" autocomplete="name"  disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row mb-25">
                                ...
                                <div class="col-9">
                                    <input name="email" type="email" value="{{ $client->email }}" class="form-control m-input" id="email" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row mb-25">
                                ...
                                <div class="col-9">
                                    <input name="company" type="text" value="{{ $client->company }}" class="form-control m-input" disabled>
                                </div>
                            </div>
                            <div class="form-group m-form__group row mb-25">
                                <label for="example-text-input" class="col-3 col-form-label">العنوان</label>
                                <div class="col-9">
                                    <input name="address"type="text" value="{{ $client->address }}" class="form-control m-input" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row mb-25">
                                ...
                                <div class="col-9">
                                    <input name="phone" type="text" value="{{ $client->phone }}" class="form-control m-input" disabled>
                                </div>
                            </div>
