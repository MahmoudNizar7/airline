                            ...
                            @if($trips->count() > 0)
                                ...
                                @foreach($trips as $trip)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-subscripe btn-hover clickThis" data-id="{{ $trip->id }}" @if(!auth('client')->check()) wire:click='clientLogin' @else  data-toggle="modal" data-target="#exampleModal" @endif><i class="icon-checked ml-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" id="exampleFormControlInput1" name="adults">
                            @error('adults') <span class="text-danger error">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput2">Children</label>
                            <input type="number"min="0" class="form-control" id="exampleFormControlInput2" name="children">
