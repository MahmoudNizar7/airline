                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row mb-25">
                                ...
                                <div class="col-9">
                                    <input name="name" wire:model="name" value=""
                            ...
                            <div class="form-group m-form__group row mb-25">
                                <label for="email" class="col-3 col-form-label">البريد
                                    الإلكتروني</label>
                                <div class="col-9">
                                    <input name="email" wire:model="email" type="email" value=""
                            ...
                            <div class="form-group m-form__group row mb-25">
                                ...
                                <div class="col-9">
                                    <input name="company" wire:model="company" type="text" value=""
                            ...
                            <div class="form-group m-form__group row mb-25">
                                ...
                                <div class="col-9">
                                    <input name="address" wire:model="address" type="text" value=""
