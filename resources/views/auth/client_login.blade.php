                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="content-warper wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                            <h3 class="two-line-heading text-center">{{ __('site.sign_in') }}</h3>
                            <form action="{{ route('client.login.post') }}" method="post">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-lg btn-hover">{{ __('site.sign_in') }}<i class="icon-left-arrow pr-1"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
